...
public class EjercicioVectoresTest {
    private static final Logger logger = LogManager.getLogger(EjercicioVectoresTest.class);
    ...
    void testTribonacci() {
        ...
        logger.info("Resultado Tribonacci: " + Arrays.toString(result));
    ...
    void testFindTotal() {
        ...
        logger.info("Resultado FindTotal: " + actualScore);
